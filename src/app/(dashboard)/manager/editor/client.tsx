...
export function EditorClient({
  ...
  const { init, isDirty, spots, obstacles, layoutId, layoutName, zone, gridWidth, gridHeight, markSaved } = useEditorStore();
          ...
          <div style={{ display: "flex", gap: "1rem", alignItems: "flex-end", flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", gap: "0.5rem" }}>
              <button
                ...
                disabled={!newName || createLayout.isPending}
                onClick={() => createLayout.mutate({ estateId: activeEstateId, name: newName, zone: newZone, gridWidth: newW, gridHeight: newH })}
              >
                {createLayout.isPending ? "Tworzenie..." : "Utwórz layout"}
              </button>
